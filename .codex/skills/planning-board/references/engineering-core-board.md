...
python3 .codex/skills/planning-board/scripts/board_ops.py create-task --title "..." --body "..." --assignee <login> --start-date YYYY-MM-DD --target-date YYYY-MM-DD
python3 .codex/skills/planning-board/scripts/board_ops.py update-task --issue 123 --status "In progress" --start-date YYYY-MM-DD --target-date YYYY-MM-DD
